...
class ParkingSpot(db.Model):
    ...
    image_file = db.Column(db.String(255), nullable=False) # extra
    # Relationships
...
class Booking(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    user_id = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=False)          # users
    parking_id = db.Column(db.Integer, db.ForeignKey('parking_spots.id'), nullable=False) # parking_spots
